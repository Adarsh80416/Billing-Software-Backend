...
import com.example1.billingsoftware1.service.ItemService;
...
public class ItemServiceImpl implements ItemService{
    ...
    public void deleteItems(String itemId) {
        ...
        if (isFileDeleted){
            ...
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Failed to delete image file for item with id: " + itemId);
        }
